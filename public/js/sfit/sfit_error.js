...
$(function () {
	...
	$("#apply_date").click(function() {
		...
		$.ajax({
			...
			//beda disini
			url: base_url+"/sfit/errorreportin",
			type: "POST",
	...
	if($("body").length > 0) {
		...
		function tableDraw() {
			...
			$(".btos").click(function(e)
			{
				...
				$.ajax({
					url: base_url+"/sfit/errorpopupin",
					type: "POST",
					dataType: "html",
