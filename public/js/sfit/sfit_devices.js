	...
	if($("body").length>0){
		//initial call
			...
			//		console.log(array[x].current_user_installs);
						all_data_list.push(new Array(array[x]["device_name"], parseInt(array[x]["current_device_installs"]), array[x]["segment"]));
					//	console.log(data_list[x]);
						total_data +=1; 
						//console.log(total_install);
				}
			...
			function tableDraw(){
				...
				$("table#slime_install tbody tr").html("<td align='center'><h1><b>"+ formatNumber(total_install) +"</td>"+"<td align='center'><h1><b>"+ formatNumber(res[2]) +"</b></h1></td>");
