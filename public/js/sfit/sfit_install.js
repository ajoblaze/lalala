	...
	if($("body").length > 0) {
		...
		function tableDraw() {
			...
			for(i = total_data-1; i >= 0; i--) {
				$("table#slime_daily_install tbody").append("<tr><td align='center'>" + categories_data[i] + "<td align='center'>" + values_data_in[i] + "</td>" + "<td align='center'>" + values_data_un[i] + "</td>" + "<td align='center'>" + active_in[i] + "</td></tr>");
			}
		}
