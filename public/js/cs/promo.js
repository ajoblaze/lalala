...
app.controller('searchCrtl', function ($scope, $http, $sce, $filter) {
	...
	$scope.loadTotal = function()
	{
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/csslime/gettotalpromo",
	...
	{		
		...
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/csslime/loadmorepromo",
	...
	$scope.showDevice = function($event, data)
	{
		...
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/csslime/getpromodevice",
	...
	$scope.showProduct = function($event, data)
	{
		...
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/csslime/getpromoproduct",
								data:  $.param({"promo_id" : data.id}),
								headers: {'Content-Type': 'application/x-www-form-urlencoded'}
							});
		$(".bg-log-loading").show();
	...
	$scope.exportCurrent = function($event)
	{
		...
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/csslime/exportcsvpromo",
