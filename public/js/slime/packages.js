...
var start_expire_date = $("#start_expire_date").val();
var end_expire_date = $("#end_expire_date").val();
...
app.controller('searchCrtl', function ($scope, $http, $sce, $filter) {
	...
	$scope.loadTotal = function()
	{
		var responsePromise = $http({
								method: 'POST',
								url: base_url+"/packages/gettotalpackage",
								data: $.param({"q" : q, "package_name" : package_name, "start_start_date" : start_start_date, "end_start_date" : end_start_date, 
