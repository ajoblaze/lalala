...
$(function () {
	...
	$("#apply_date").click(function() {
		...
		$.ajax({
			url: base_url+"/sgift/errorreportin",
			type: "POST",
	...
	if($("body").length > 0) {
		...
		function tableDraw() {
			...
			for(i = total_data-1; i >= 0; i--) {
				...
				"<a><button type='button' data-flag='1' data-tgl='"+categories_data[i]+"' class='btos btn btn-danger' ><span></span>&nbsp; <span class='action-text'>"+os[i]+"</span>&nbsp; </button></a>" + "</td>" + "<td align='center'>" + 
				"<a><button type='button' data-flag='2' data-tgl='"+categories_data[i]+"' class='btdevice btn btn-warning'><span></span>&nbsp; <span class='action-text'>"+device[i]+"</span>&nbsp; </button></a>" + "</td>" + "<td align='center'>" + 
				"<a><button type='button' data-flag='3' data-tgl='"+categories_data[i]+"' class='btappversion btn btn-primary'><span></span>&nbsp; <span class='action-text'>"+app_version[i]+"</span>&nbsp; </button></a>" + "</td>"+ "<td align='center'>" + 
				"<a><button type='button' data-flag='4' data-tgl='"+categories_data[i]+"' class='btdetail btn btn-info'><span></span>&nbsp; <span class='action-text'>"+detail[i]+"</span>&nbsp; </button></a>" + "</td></tr>");
			}
			...
			$(".btos").click(function(e)
			{
				...
				$.ajax({
					url: base_url+"/sgift/errorpopupin",
					type: "POST",
					dataType: "html",
