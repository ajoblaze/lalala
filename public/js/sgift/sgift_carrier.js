...
$(function () {
	...
	$("#apply_date").click(function(){
		...
		start_date = $.datepicker.formatDate( "yy-mm-dd", $("#datepicker1").datepicker("getDate"));
				$.ajax({
							url: base_url+"/sgift/pullcarrier",
							type: "POST",
	...
	if($("body").length>0){
		//initial call
			...
			//		console.log(array[x].current_user_installs);
						all_data_list.push(new Array(array2[x]["carrier_name"], parseInt(array2[x]["current_device_installs"])));
